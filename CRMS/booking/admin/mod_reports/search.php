...
<div class="container">
	<div class="panel panel-primary">
		...
		<h3>Date Filter :: </h3>
		 ...
		 <input class="form-control date start input-lg" size="20" type="text" value="<?php echo (isset($_SESSION['start'])) ? $_SESSION['start'] : ''; ?>" Placeholder="Pick up Date" name="start" id="from" data-date="" data-date-format="yyyy-mm-dd" data-link-field="any" data-link-format="yyyy-mm-dd">
		 </div>
		  <div class="form-group">
		    <label class="sr-only" for="exampleInputPassword2">Check Out:</label>
		      <input class="form-control date end input-lg" size="20" type="text" value="<?php echo (isset($_SESSION['end'])) ? $_SESSION['end'] : ''; ?>"  Placeholder="Drop off Date"  name="end" id="end" data-date="" data-date-format="yyyy-mm-dd" data-link-field="any" data-link-format="yyyy-mm-dd">
		  </div>
...
<td ><strong>Day Rate(RWF)</strong></td>
...
if(isset($_POST['submit'])){
	...
	$cur = $mydb->loadResultList();
		...
		echo '<tr><td colspan="7" align="center"><h2>No details available!</h2></td></tr>';
